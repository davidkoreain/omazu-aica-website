...
export const LandingView: React.FC<LandingViewProps> = ({
  ...
  return (
    <div className="space-y-24 pb-20">
      ...
      <section className="relative pt-8 lg:pt-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-blue-950/80 border border-cyan-800/60 text-cyan-300 text-xs font-semibold animate-pulse">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-2">
              <button
                ...
                className="px-8 py-4 rounded-xl bg-gradient-to-r from-blue-600 via-indigo-600 to-cyan-600 hover:from-blue-500 hover:to-cyan-500 text-white font-bold text-sm shadow-xl shadow-blue-600/30 transition-all hover:scale-105 flex items-center justify-center gap-2"
              >
              ...
              <button
                ...
                className="px-8 py-4 rounded-xl bg-slate-900 hover:bg-slate-800 border border-slate-700 text-slate-200 font-bold text-sm transition-all hover:scale-105 flex items-center justify-center gap-2"
              >
        ...
        {/* TRUST BAR / FASOO MOU */}
        <div className="mt-16 pt-8 border-t border-slate-800/80 max-w-7xl mx-auto">
          <div className="glass-card p-4 rounded-2xl flex flex-wrap items-center justify-between gap-4 text-xs">
            <div className="flex items-center gap-3">
              ...
              <span className="text-slate-300 border-l border-slate-700 pl-3">
                AX 교육·컨설팅 협력 MOU
              </span>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {DIAGNOSTIC_DOMAINS.map((item, idx) => (
            ...
            >
              ...
              <div className="pt-4 border-t border-slate-800 text-xs text-cyan-400 font-medium flex items-center gap-1.5">
      ...
      {/* TWO PATHS (CHOOSE YOUR PATH WITH IMAGES) */}
      <section className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
          ...
          <div className="glass-card rounded-3xl border border-blue-800/40 overflow-hidden flex flex-col justify-between group hover:border-blue-500/60 transition-all">
            <div className="relative h-56 overflow-hidden">
              <img 
                ...
                alt="OMAZU B2B Executive AX Consulting Session" 
            ...
            <div className="p-8 flex-1 flex flex-col justify-between space-y-6">
              ...
              <div className="flex gap-3 pt-4">
                <button
                  ...
                  className="flex-1 py-3.5 px-4 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-bold text-xs flex items-center justify-center gap-1.5 transition-colors"
                >
                  Consulting 자세히 보기
                </button>
                <button
                  onClick={openInquiryModal}
                  className="py-3.5 px-4 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-200 font-bold text-xs transition-colors"
                >
                  기업 문의
                </button>
              </div>
          ...
          <div className="glass-card rounded-3xl border border-indigo-800/40 overflow-hidden flex flex-col justify-between group hover:border-indigo-500/60 transition-all">
            ...
            <div className="p-8 flex-1 flex flex-col justify-between space-y-6">
              ...
              <div className="flex gap-3 pt-4">
                <button
                  onClick={() => setActiveTab('academy')}
                  className="flex-1 py-3.5 px-4 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-bold text-xs flex items-center justify-center gap-1.5 transition-colors"
                >
                  Academy 과정 보기
                </button>
                <button
      ...
      {/* FASOO PARTNERSHIP HIGHLIGHT WITH SECURITY IMAGE */}
      <section className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 items-center">
            ...
            <div className="lg:col-span-7 p-8 lg:p-12 space-y-4">
              ...
              <div className="pt-2">
                <button
                  onClick={openInquiryModal}
                  className="py-3.5 px-6 bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-500 hover:to-cyan-500 text-white font-bold text-xs rounded-xl shadow-lg transition-all"
                >
                  Fasoo 연계 상담 신청
                </button>
              </div>
            ...
            <div className="lg:col-span-5 h-full relative min-h-[280px]">
              <img 
                src="/images/security_data_trust.jpg" 
                alt="Fasoo and OMAZU Data Security Trust Shield" 
